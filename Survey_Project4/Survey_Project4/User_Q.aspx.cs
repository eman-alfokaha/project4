...
namespace Survey_Project4
{
    public partial class User_ : System.Web.UI.Page
    {
       private int i;
        ...
        {
            string path = Server.MapPath("Lubna.txt");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string p = Server.MapPath("Login.txt");
            string page = Server.MapPath(path);

            using (StreamWriter writee = File.AppendText(p))
            {
                
                writee.WriteLine(z + " " + localDate);
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Your survey has been uploaded successfully, thank you')", true);
